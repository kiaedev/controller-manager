...
//+kubebuilder:rbac:groups=core.my.domain,resources=middlewares,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=core.my.domain,resources=middlewares/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=core.my.domain,resources=middlewares/finalizers,verbs=update
